...
class FileVault extends \Arnapou\Toolbox\Vault\FileVault {
	 ...
	 * @return FileVault
	 */
	static public function getVaultRender() {
	 ...
	 * @return FileVault
	 */
	static public function getVaultProfessions() {
		return self::getInstance('professions');
	}
	 ...
	 * @return FileVault
	 */
	static public function getVaultCrafting() {
		return self::getInstance('crafting');
	}
	...
	public function getResponse($url) {
		...
		if ($this->exists($url)) {
			...
			if (time() - filemtime($filepath) < 86400 * 30) {
